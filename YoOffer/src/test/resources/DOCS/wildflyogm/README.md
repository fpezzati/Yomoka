Here I add Dockerfile and configuration files I use to build fpezzati/wildflyogm image which can be found [here](https://hub.docker.com/r/fpezzati/wildflyogm/).
