...
public class OfferServiceTest {
    ...
    @Test
    public void pickItemsAboutNonExistingOffer() throws OfferException {
    ...
    @Test
    public void pickTooMuchItems() throws OfferException {
	offer = Mockito.mock(Offer.class);
    ...
    @Test
    public void pickEnoughItems() throws OfferException {
	offerService = Mockito.spy(offerService);
	offer = Mockito.mock(Offer.class);
